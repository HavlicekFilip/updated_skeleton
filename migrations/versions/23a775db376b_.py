...
Revision ID: 23a775db376b
Revises: None
Create Date: 2017-10-03 11:17:36.146668

"""

# revision identifiers, used by Alembic.
revision = '23a775db376b'
down_revision = None
...
def upgrade():
    ...
    op.create_table('letadlo',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('pohlavi', sa.Integer(), nullable=True),
    sa.Column('typ_letadla', sa.Integer(), nullable=True),
    sa.PrimaryKeyConstraint('id', name='pk_letadlo'),
    sqlite_autoincrement=True
    )
    op.create_table('emaily',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('email', sa.String(length=64), nullable=False),
    sa.Column('jmeno', sa.String(length=64), nullable=False),
    sa.PrimaryKeyConstraint('id', name='pk_emaily')
    )
    op.create_index('ix_emaily_email', 'emaily', ['email'], unique=True)
    op.create_index('ix_emaily_jmeno', 'emaily', ['jmeno'], unique=True)
    op.create_table('it3sit',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.PrimaryKeyConstraint('id', name='pk_it3sit'),
    sqlite_autoincrement=True
    )
    op.create_index('ix_it3sit_prijmeni', 'it3sit', ['prijmeni'], unique=False)
...
def downgrade():
    ...
    op.drop_table('maso')
    op.drop_index('ix_it3sit_prijmeni', table_name='it3sit')
    op.drop_table('it3sit')
    op.drop_index('ix_emaily_jmeno', table_name='emaily')
    op.drop_index('ix_emaily_email', table_name='emaily')
    op.drop_table('emaily')
    op.drop_table('letadlo')
    ### end Alembic commands ###
